...
export default function Features() {
  return (
    <div className="w-full max-w-none flex justify-center items-center z-10 mx-auto overflow-x-auto no-scrollbar">
      <div className="flex items-center gap-6 md:gap-8 py-4">
        <motion.div
